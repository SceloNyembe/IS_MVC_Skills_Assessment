...
namespace DEV_3.MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly PersonBusiness _PersonBusiness = new PersonBusiness();
       ...
       public AccountController()
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if(model.Email=="admin@admin.com")
                    {
                        ...
                        return RedirectToAction("DashPerson", "Home");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var person = _PersonBusiness.GetAllPerson().Where(x => x.id_number == model.id_number).FirstOrDefault();
                if (person!=null)
                {
                ...
                { 
                    ...
                    if(person==null)
                    {
                        _PersonBusiness.AddPerson(new PersonViewModel()
                        {
                            name = model.name,
